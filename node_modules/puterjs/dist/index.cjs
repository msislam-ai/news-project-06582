...
exports.isPuterScriptLoaded = isPuterScriptLoaded;
exports.getPuter = getPuter;
exports.withPuter = withPuter;
 ...
 */
async function withPuter(callback) {
